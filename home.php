...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link btn disabled" href="home.php">Home</a>
    </li>
	...
	<div class="center">
		<div class="container-fluid">
			...
			<div class="row">
		 	...
		 	<div class="row">
		 		<div class="col-25">
			 		<input type="submit" class="btn" name="submit" value="Add Details" />
				</div>
				<div class="col-25">
...
if(isset($_POST["submit"]))
 {
$q1=mysqli_query($conn,"INSERT into bhup values('$cap1','$cap2','$session','$rn','$branch','$year','$semester','$bday','$cap3')");

if($q1)
{
	echo'<div class="alert " id="success"> <span class="closebtn" onclick="this.parentElement.style.display="none";">&times;</span> <strong>Success!</strong> Information Recorded
</div><script>
...
echo'<div class="alert alert-dismissible" id="warning"> <span class="closebtn" onclick="this.parentElement.style.display="none";">&times;</span> <strong>Record Not Added,</strong> Check Details Again
</div><script>
var close = document.getElementsByClassName("closebtn");
var i;
for (i = 0; i < close.length; i++) {
