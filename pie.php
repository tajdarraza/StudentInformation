...
type: 'pie',
    data: {
        ...
        datasets: [{
            label: '# of Students',
            data: ['<?php print($cs); ?>','<?php print($ec); ?>','<?php print($is); ?>','<?php print($me); ?>','<?php print($cv); ?>','<?php print($ee); ?>'],
            backgroundColor: [
              'rgba(255, 99, 132, 0.4)',
                'rgba(54, 162, 235, 0.4)',
                'rgba(255, 206, 86, 0.4)',
...
<button class="btn btn-info" id ="dbtn" onclick="location.href='data.php'"> See in Bar
</button>
</body>
</html>